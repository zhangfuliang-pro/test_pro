...
static U32 _HAL_FSP_SendOneCmd(U8 u8Cmd)
{
    //FSP init config
    FSP_WRITE(REG_FSP_CTRL, (ENABLE_FSP|RESET_FSP|INT_FSP));
    FSP_WRITE(REG_FSP_CTRL2, 0);
...
U32 HAL_SPINAND_Write(U32 u32_PageIdx, U8 *u8Data, U8 *pu8_SpareBuf)
{
    ...
    if(BDMA_W_FLAG && (pu8_SpareBuf == NULL))
    {
...
BOOL HAL_SPINAND_DumpCkg(void)
{
    ...
    //DEBUG_SPINAND(E_SPINAND_DBGLV_ERR, printf("PM CLK %X\r\n", u16Reg));
    ...
    //DEBUG_SPINAND(E_SPINAND_DBGLV_ERR, printf("NON PM CLK %X\r\n", u16Reg));
