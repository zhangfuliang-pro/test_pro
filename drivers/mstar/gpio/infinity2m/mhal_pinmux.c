...
static S32 HalPadSetMode_MISC(U32 u32PadID, U32 u32Mode)
{
    ...
    if ((PAD_DM_P1 == u32PadID) || (PAD_DP_P1 == u32PadID))
        utmi_bank = UTMI0_BANK;
    else if ((PAD_DM_P2 == u32PadID) || (PAD_DP_P2 == u32PadID))
        utmi_bank = UTMI1_BANK;
    else if ((PAD_DM_P3 == u32PadID) || (PAD_DP_P3 == u32PadID))
    ...
    case PADA_IDAC_OUT_B: /* reg_gpio_en_pad_out_b; reg[112720]#0=1b */
        if (u32Mode == PINMUX_FOR_GPIO_MODE) {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), REG_GPIO_EN_PAD_OUT_B_MASK, REG_GPIO_EN_PAD_OUT_B_MASK);
        }
        else {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), 0, REG_GPIO_EN_PAD_OUT_B_MASK);
        }
        break;
    case PADA_IDAC_OUT_G: /* reg_gpio_en_pad_out_b; reg[112720]#1=1b */
        if (u32Mode == PINMUX_FOR_GPIO_MODE) {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), REG_GPIO_EN_PAD_OUT_G_MASK, REG_GPIO_EN_PAD_OUT_G_MASK);
        }
        else {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), 0, REG_GPIO_EN_PAD_OUT_G_MASK);
        }
       break;
    case PADA_IDAC_OUT_R: /* reg_gpio_en_pad_out_b; reg[112720]#2=1b */
        if (u32Mode == PINMUX_FOR_GPIO_MODE) {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), REG_GPIO_EN_PAD_OUT_R_MASK, REG_GPIO_EN_PAD_OUT_R_MASK);
        }
        else {
            _GPIO_W_WORD_MASK(_RIUA_16BIT(DAC_ATOP_BANK,REG_GPIO_EN_PAD_OUT), 0, REG_GPIO_EN_PAD_OUT_R_MASK);
        }
        break;
