...
#if defined(CHIP_MV2)
#define REG(bank, addr)              (*((volatile MS_U16 *)((0xF0000000+(bank)) + ((addr)))))
#define PMREG(bank, addr)              (*((volatile MS_U16 *)((0xF0000000+(bank)) + ((addr)))))
#define REG8(bank, addr)             (*((volatile MS_U8 *)((0xF0000000+(((MS_U32)bank))) + (((MS_U32)addr)))))
#else
...
#define REG8(bank, addr)             (*((volatile MS_U8 *)(((MS_U32)_gPM_MapBase+(((MS_U32)bank)<<1U)) + (((MS_U32)addr)<<1U))))
#endif
...
MS_BOOL i2cBurstWriteBytes(MS_U8 ucSlaveAdr, MS_U8 ucSubAdr, MS_U8 *pBuf, MS_U16 ucBufLen)
{
    ...
    return result;
#else
    return DrvHdmitxOsSetI2cWriteBytes(ucSlaveAdr, ucSubAdr, pBuf, ucBufLen);
#endif
}
