...
static void _HDMITx_Isr(MS_U32 u32IntNum)
{
    MS_U32 irq_status;
    //u32IntNum = u32IntNum;      // prevent compile warning
    DBG_HDCP(printf("_HDMITx_Isr!!! %d \r\n", u32IntNum)); // Fix coverity impact.
...
#if 0 //ENABLE_CEC_INT
static void _HDMITX_CEC_RxIsr(InterruptNum u32IntNum)
{
    //u32IntNum = u32IntNum;      // prevent compile warning
...
void _MDrv_HDCPTx_StopRiTimer(void)
{
    ...
    {
        DrvHdmitxOsStartTimer(&_tHDCPRiTimerCfg);
    }
}
        		...
        		case HDCP14Tx_MainState_A4:
        			switch (psHDMITXResPri->stHdcpTxInfo.hdcp14tx_SubState)
        			{
        				...
        				case HDCP14Tx_SubFSM_AuthDone:
                            ...
                            {
                                DrvHmidtxOsDeleteTimer(&_tHDCPRiTimerCfg);
                                _s32HDCPRiTimerId = -1;
                            }
...
MS_BOOL MDrv_HDMITx_Init(void *pInstance)//MS_BOOL MDrv_HDMITx_Init(void)
{
    ...
    DBG_HDMITX(printf("Get IOMAP ID:%u Base:%x!\n", E_HDMITX_OS_MMIO_PM, (unsigned int)psHDMITXResPri->stHDMITxInfo.u32PMRIUBaseAddress));
...
#if DDC_I2C_TYPE == DDC_I2C_HW
    if(DrvHdmitxOsSetI2cAdapter(1) == 0) //ToDo bus number ??
    {
        return FALSE;
    }
#endif
...
void MDrv_HDMITx_MDCMDGetInfo(void* pInstance, MS_U64* u64ReqHdl)
{
...

    {
        ...
        MdbPrint(u64ReqHdl, "----------------  Sstar HDMITx Info -----------------\n");
        //Basic Status
        ...
        //Video
        MdbPrint(u64ReqHdl, "----------------  Sstar HDMITx Video Info -----------\n");
        ...
        //Audio
        MdbPrint(u64ReqHdl, "----------------  Sstar HDMITx Audio Info -----------\n");
        ...
        //EDID
        MdbPrint(u64ReqHdl, "----------------  Sstar HDMITx EDID Info ------------\n");
        ...
        //HDCPTx
        MdbPrint(u64ReqHdl, "----------------  Sstar REE HDCPTx Info -------------\n");
