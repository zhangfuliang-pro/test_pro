...
#define BASE_REG_ISP_ADDR			GET_REG_ADDR(MS_BASE_REG_RIU_PA, 0x000400)
#define BASE_REG_PM_MISC_ADDR		GET_REG_ADDR(MS_BASE_REG_RIU_PA, 0x001700)
#define BASE_REG_PIU_ADDR			GET_REG_ADDR(MS_BASE_REG_RIU_PA, 0x001E00)
#define BASE_REG_CLKGEN0_ADDR		GET_REG_ADDR(MS_BASE_REG_RIU_PA, 0x080580)
